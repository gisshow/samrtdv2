    ...
    install: function (viewer, callback) {
        ...
        var stage = viewer.scene.postProcessStages.add(
            new Cesium.PostProcessStage({
                ...
                uniforms: {
                    highlight: function () {
                        return Cesium.Color.fromCssColorString('#3AA5E8');;
                    },
                },
            })
        );
        ...
        this.onLeftClick = function (movement) {
            ...
            //     window.pickObj=pickedObjects[0];
            ...
            console.log(self.selected.feature,pickedFeature)

            //如果不是相同楼层，则缩回
            if(self.selected.floorTile && self.selected.floorTile!==pickedFeature.content.tile.parent.parent){
                var root=self.selected.floorTile;
                let mat=root.children[0].transform;
                Cesium.Matrix4.multiplyByTranslation(mat, new Cesium.Cartesian3(-60,0,0), mat);
                root.children[0].transform.transform=mat;
            ...
            // self.selected.floorTile=pickedFeature.content.tile.parent.parent;
