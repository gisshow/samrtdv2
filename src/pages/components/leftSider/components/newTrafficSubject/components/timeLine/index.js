            ...
            <RootContainer>
                <div className={styles.timeline}>
                    <div className={styles.timeContral}>
                        <Slider tooltipVisible={false} marks={marks} max={100}  onChange={this.onTimeChange}/>
                    ...
                    {
                       percent!==0 && percent!==100 && <div className={styles.timeBox} style={{left:`${percent}%`}}><span>{currentTime}</span></div>
                    }
                </div>
