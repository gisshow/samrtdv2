             ...
             chartData ? (<>
              <div className={styles.title}>
                  ...
                  <div className={styles.slider}>
                    <Slider style={{width:'265px',marginLeft:0}} min={1} max={2000} value={range} onChange={(value)=>this.onChangeBoundary(value)}/>
                    {/* <span className={styles.radius}>{range}m</span> */}
                    <InputNumber min={0} max={2000} style={{ marginLeft: 6,marginRight:10 }} step={1} value={range}  onChange={(value)=>{this.onInputChange(value)}}/>
                  </div>
              </div>
              <div>
                <div className={styles.head}>
                  <div className={styles.item}>
                    ...
                    <span className={styles.name}>人口信息</span>
                    {
                        chartData && <Pieslice data={chartData['gender'].stat} type={'gender'} isShowLabel={true} height={300} padding={[0 ,0 ,10 ,0]}/>
                    }
                  </div>
                </div>
              </div> 
