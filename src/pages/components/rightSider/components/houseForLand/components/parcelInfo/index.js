        ...
        <div className={styles.box}>
          ...
          <div className={styles.scrollBox}>
            ...
            <div className={styles.item}>
              <span className={styles.name}>地块代码:</span>
              <span className={styles.value}>{parcelInfo.parcelNo}</span>
            </div>
            <div className={styles.item}>
              <span className={styles.name}>所属区:</span>
              <span className={styles.value}>{parcelInfo.quName}</span>
            </div>
            <div className={styles.item}>
              <span className={styles.name}>所属街道:</span>
              <span className={styles.value}>{parcelInfo.jdName}</span>
            </div>
