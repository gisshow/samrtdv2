          ...
          <div className={styles.scrollBox}>
            <div className={styles.content}>
              <div className={styles.item}>
                <span className={styles.name}>楼栋编码:</span>
                <span className={styles.value}>{buildingInfo.bldgNo}</span>
              </div>
              <div className={styles.item}>
                <span className={styles.name}>楼栋名称:</span>
                <span className={styles.value}>{buildingInfo.nowname}</span>
              </div>
              <div className={styles.item}>
                <span className={styles.name}>楼栋地址:</span>
