var fixGltf = function(gltf) {
    ...
    var v =  gltf.extensionsUsed?gltf.extensionsUsed.indexOf('KHR_technique_webgl'):-1;
    var t = gltf.extensionsRequired?gltf.extensionsRequired.indexOf('KHR_technique_webgl'):-1;
    // 中招了。。
    if (v !== -1) {
