...
function initWidgetView(_thisWidget) {
    ...
    $("#btn_marker_Add").mouseover(function () {
        //判断倾斜摄影已加载 是否关闭3D模式
        var is3Denable = thisWidget.is3Denable();
        if(is3Denable){
            $("#btn_marker_Add").css("cursor","pointer");
            Addenable=true;
        }else{
            //0111,下面两行注释解决新增按钮被禁用问题，此功能被产品报bug
            // $("#btn_marker_Add").css("cursor","no-drop");
            // Addenable=false;
            Addenable=true;
        }
    });
