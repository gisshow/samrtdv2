...
(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  class CesiumWind {
    ...
    getValue(lon,lat){
      return  this.field.valueAt(lon,lat);
    }
    addTo(viewer) {
      this.viewer = viewer;
      this.appendCanvas();
    ...
    updateOptions(colors,min,max,path){
      this.wind.options.colorScale=colors;
      this.wind.options.minVelocity=min;
      this.wind.options.maxVelocity=max;

      if(path){
        this.wind.options.paths=path;
        this.wind.prepareParticlePaths();
      }
    ...
    updateOptionVilaty(velocityScale){
      this.wind.options.velocityScale=velocityScale;
    }

    updateOptionsPath(path){
      this.wind.options.paths=path;
